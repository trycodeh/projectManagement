...
public class AddProject extends JFrame implements ActionListener{
    ...
    AddProject() {
        ...
        JLabel labelfname = new JLabel("Project Title");
        ...
        JLabel labeldob = new JLabel("Project Starting Date");
        ...
        JLabel labeleducation = new JLabel("Project Type");
        labeleducation.setBounds(400, 300, 150, 30);
        labeleducation.setFont(new Font("serif", Font.PLAIN, 20));
        add(labeleducation);
        
        String courses[] = {"Desktop Program,Mobile Applicatin,web Application"};
        cbeducation = new JComboBox(courses);
        cbeducation.setBackground(Color.WHITE);
        cbeducation.setBounds(600, 300, 300, 30);
        add(cbeducation);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            try {
                Conn conn = new Conn();
                    String query = "insert into Project values('"+name+"', '"+fname+"', '"+dob+"', '"+address+"', '"+phone+"', '"+email+"', '"+education+"', '"+ProId+"')";
